...
int main() {
	...
	unsigned char *data = stbi_load("light_old.jpg", &width, &height, &nrChannels, 0);
	if (data)
	{
	...
	stbi_image_free(data);
	//Texture texture2("awesomeface.png", width, height, nrChannels);
	...
	engine.loop(display.window, shader, VAO, texture1, texture2, cubePositions);
